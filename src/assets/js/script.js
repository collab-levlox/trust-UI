...
document.addEventListener("DOMContentLoaded", () => { // circle count
...
//   const swiper = new Swiper(".what-we-do-slider", {
//     slidesPerView: 3,
//     spaceBetween: 30,
//     loop: true,
//     navigation: {
...
const buttons = document.querySelectorAll(".tab-btn"); //abt us tab
...
document.addEventListener("scroll", function () {  //header sticky
