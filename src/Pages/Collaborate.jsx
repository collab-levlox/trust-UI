  ...
  <div className="off-canvas-menubar-overlay" data-close="menubar"></div>
	...
	<div className="container">
		<div className="row" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
			<div className="col-xl-4 m-b-30">
				<div className="project-card style-service">
					<div className="thumb">
						<a href='/econest/services-details'><img alt="thumb-63" src="/src/assets/img/thumbs/thumb-68.webp" /></a>
			...
			<div className="col-xl-4 m-b-30">
				<div className="project-card style-service">
					<div className="thumb">
						<a href='/econest/services-details'><img alt="thumb-63" src="/src/assets/img/thumbs/thumb-14.webp" /></a>
						<div className="content">
			...
			<div className="col-xl-4 m-b-30">
				<div className="project-card style-service">
					<div className="thumb">
						<a href='/econest/services-details'><img alt="thumb-63" src="/src/assets/img/thumbs/thumb-15.webp" /></a>
						<div className="content">
			...
			<div className="col-xl-4 m-b-30">
				<div className="project-card style-service">
					<div className="thumb">
						<a href='/econest/services-details'><img alt="thumb-63" src="/src/assets/img/thumbs/thumb-66.webp" /></a>
						<div className="content">
							<h5>Community Development Program</h5>
