              ...
              blogCards.forEach(card => card.removeEventListener('mouseleave', handleMouseLeave));
                  ...
                  useEffect(() => {
                    ...
                    const onScroll = () => {
                      ...
                      const trigger = window.innerHeight * 0.35 // 30%
		...
		<div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
			<div class="col-xl-4 col-md-6 col-sm-12 m-b-30">
				<div class="blog-card-2">
					<div class="thumb">
						<a>
							<img src="/src/assets/img/thumbs/thumb-32.webp" alt="thumb"/>
						</a>
						...
						<div class="details-btn">
							<Link to="/blogdetails" class='e-primary-btn has-icon is-hover-white' >
								...
								<span class="icon-wrap">
									<span class="icon"><i class="fas fa-arrow-right"></i><i class="fas fa-arrow-right"></i></span>
								</span>
							</Link>
						</div>
					</div>
			...
			<div class="col-xl-4 col-md-6 col-sm-12 m-b-30">
				<div class="blog-card-2">
					...
					<div class="content">
						...
						<div class="details-btn">
							<a class='e-primary-btn has-icon is-hover-white' href='/econest/services-details'>
								KNOW MORE
								<span class="icon-wrap">
									<span class="icon"><i class="fas fa-arrow-right"></i><i class="fas fa-arrow-right"></i></span>
								</span>
			...
			<div class="col-xl-4 col-md-6 col-sm-12 m-b-30">
				<div class="blog-card-2">
					<div class="thumb">
						<a href='/src//econest/blog-details'>
							<img src="/src/assets/img/thumbs/thumb-32.webp" alt="thumb"/>
						</a>
						<div class="event-date">
							<h2>09</h2>
